  ...
  return (
    <div>
      {props.isVisible && (
        ...
        >
            <div className='pl-9 pt-3 pb-7'>
                <img src={User} alt='user' className='w-[80%]'/>
            </div>
            <div className="p3-4 overflow-y-auto">
                <ul className="space-y-2 font-medium">
                    ...
                    <li>
                        ...
                        <span className="ml-3">Invest</span>
                        </a>
                    </li>
                    <li>
                        <a href="/wallet" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        ...
                        <span className="ml-3">Reward</span>
                        </a>
                    </li>
                    <li>
                        <a href="/wallet" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span className="ml-3">My Referral Link</span>
                        </a>
                    </li>
                    <li>
                        <a href="/wallet" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span className="ml-3">Circles</span>
                        </a>
                    </li>
